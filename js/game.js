...
{
    this.load.image('rubin', 'img/cheese.png');
    this.load.image('platform', 'img/platform.png');
    this.load.image('spaceship', 'img/spaceship.png');
    this.load.image('alien', 'img/mountain.png');
    this.load.image('star', 'img/moonstone.png');
    this.load.image('ground', 'img/ground.png');
    this.load.image('fon+', 'img/fon+.png');
